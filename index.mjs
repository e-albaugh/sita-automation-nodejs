...
import { authenticateAndGetSessionCookie, updateManualActionStatus/*, startQualityGate*/ } from './src/updateValueEdge.js';
...
async function main() {
    try {
        ...
        */
        ...
        /*
        console.log("Starting ValueEdge Quality Gate...")
        await startQualityGate(cookie);
        */
